  ...
  const Jovia_md = require('../lib/commands')
...
╰━━━━━━━━━━━━━━⊷\n`
  ...
  Jovia_md.amd({
          pattern: "owner",
          desc: "To Check The Owner Of The Bot",
          category: "general",
          react: "💜",
          filename: __filename
      },
  ...
  async(Jovia, msg, text ,{isCreator }) => {
   ...
   let arr = []; 
   const cmd = Jovia_md.commands.find((cmd) => cmd.pattern === (cmdName)) || Jovia_md.commands.find((cmd) => cmd.alias && cmd.alias.includes(cmdName))
